"""
===============================================================================
EXAMPLE 4 DEPLOYMENT & EXECUTION RUNNER
===============================================================================
Description:
    Packages lambda_function.py, creates the user processor function, 
    invokes it with user_payload.json, and prints returned user record.
...
FUNCTION_NAME = "user-registration-processor-example"
ROLE_ARN = "arn:aws:iam::123456789012:role/lambda-user-role"
RUNTIME = "python3.12"
HANDLER = "lambda_function.lambda_handler"

EVENT_FILE = os.path.join(os.path.dirname(__file__), "user_payload.json")
...
def main():
    ...
    try:
        ...
        lambda_client.create_function(
            ...
            Description="Example 4: User Registration Processor",
            Timeout=15,
            MemorySize=128
        )
    ...
    try:
        print("⚡ Invoking User Registration Data Processor function...")
        ...
        print("\n📊 Returned Registered User Data Record:")
