"""
===============================================================================
EXAMPLE 2 DEPLOYMENT & EXECUTION RUNNER
===============================================================================
Description:
    Packages lambda_function.py, creates the serverless API function, invokes it 
    with sample_api_request.json, and prints response payload.
...
FUNCTION_NAME = "serverless-api-backend-example"
ROLE_ARN = "arn:aws:iam::123456789012:role/lambda-api-role"
RUNTIME = "python3.12"
HANDLER = "lambda_function.lambda_handler"

EVENT_FILE = os.path.join(os.path.dirname(__file__), "sample_api_request.json")
...
def main():
    ...
    try:
        ...
        lambda_client.create_function(
            ...
            Description="Example 2: Serverless REST API Backend",
            Timeout=15,
            MemorySize=128
        )
    ...
    try:
        print("⚡ Invoking Serverless REST API function...")
        ...
        if "body" in result_json and isinstance(result_json["body"], str):
            result_json["parsed_body"] = json.loads(result_json["body"])

        print("\n📊 Returned API Gateway Proxy Response:")
